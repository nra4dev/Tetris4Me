...
public class State extends Component {
	...
	private long gameTime;     // += (systemtime - currenttime) at start of processCycle
	private long currentTime;  // = systemtime at start of processCycle
	...
	public static State getInstance(GameActivity ga) {
		if(instance == null)
			instance = new State(ga);
		return instance;
	}

	public static State getNewInstance(GameActivity ga) {
		instance = new State(ga);
		return instance;
	}
